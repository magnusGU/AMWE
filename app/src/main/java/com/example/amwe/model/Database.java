...
public class Database {
    ...
    /**
     * Gives reference to the Database.
     *
     * @return A DatabaseReference to the Database.
     */
    ...
    /**
     * Gives reference to all the listings in the Database.
     *
     * @return A DatabaseReference of listings
     */
    ...
    /**
     * Gives reference to the user signed in.
     *
     * @return A DatabaseReference to CurrentUser.
     */
     ...
     *
     * @param newEntry The item that wants to be added.
     */
    ...
    /**
     * Deletes listing from the database.
     *
     * @param id Id of the listing that should be removed.
     */
     ...
     *
     * @param uid  The user-id generated by firebase auth.
     ...
     *
     * @return the name of CurrentUser.
     */
    ...
    static public void addUserListener(final List<Item> bookListings, final ListingAdapter adapter) {
    ...
    static public void addFavouritesListener(final List<Item> bookListings, final ListingAdapter adapter) {
